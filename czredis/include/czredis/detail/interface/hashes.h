...
struct i_hashes
{
    ...
    virtual void hmset(cref_string key, cref_string_map fields_values) = 0;
...
struct i_one_key_direct_hashes
{
    ...
    virtual czstring hmset(cref_string key, cref_string_map fields_values) = 0;
...
struct i_one_key_delay_hashes
{
    ...
    virtual delay<czstring> hmset(cref_string key, cref_string_map fields_values) = 0;
